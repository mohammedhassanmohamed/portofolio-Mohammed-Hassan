    ...
    <>
      <footer>
        ...
        <div className="two-icon">
          <h2 id="latest-part">about my self</h2>
          <p id="latest-part">
            i enjoy discussing new projects and desiegn challenges
          </p>
          <a href="https://www.facebook.com/hamada.hassan.1460" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="40"
              height="40"
